...
## npm-blastro ##
  > I created an NPM module using code originally written by Peter Hayes (1999) and Ole Nielsen (2002). If you would like to use the same module, you can install it by running: <pre><code>npm install blastro</code></pre> The repository for npm-blastro can be found <a href="http://www.github.com/jgladch/npm-blastro">here</a>.
